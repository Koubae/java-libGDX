...
public final class AppConfig {
    ...
    private AppConfig(Environment environment, StartScreen startScreen) {
        this.environment = environment;
        this.startScreen = startScreen;
    }

    public static AppConfig defaults() {
        return new AppConfig(Environment.PROD, StartScreen.MAIN_MENU);
    }
    ...
    public static AppConfig load() {
        ...
        return new AppConfig(environment, startScreen);
    }
